...
export default function AddProductPage(){ //To get recent change values
        ...
        <div className="w-full h-full flex justify-center items-center">
            <div className="w-[600px] h-auto border-[3px] rounded-[15px] flex flex-wrap flex-row justify-between p-[40px]">
                <div className="w-[200px] flex flex-col gap-[5px]">
                    ...
                    <input value={productId}  onChange={(e)=>{setProductId(e.target.value)}} type="text" className="w-full border-[1px] h-[40px] rounded-md"/>
                </div>
